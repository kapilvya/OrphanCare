    ...
    <div class="ui container">
        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                ...
                <h2 class="ui block header">Program 1</h2>
                ...
                <h2 class="ui block header">Program 2</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header">Program 3</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header">Program 4</h2>
                <div class="ui medium images">
                ...
                <h2 class="ui block header">Program 5</h2>
                <div class="ui medium images">
