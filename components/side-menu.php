...
<div class="four wide column" id="example1">
    <div class="ui secondary vertical pointing menu">
        ...
        <a class="item <?php echo ($_SERVER['PHP_SELF'] == "/orphan/feedback-form.php" ? "active" : "");?>" href="feedback-form.php">Contact Us</a>
        <a class="item <?php echo ($_SERVER['PHP_SELF'] == "/orphan/contact-us.php" ? "active" : "");?>" href="contact-us.php">About Us</a>
    </div>
</div>